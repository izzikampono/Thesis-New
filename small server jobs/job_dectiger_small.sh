...
#SBATCH --error=error_file_dectiger_small.txt
#SBATCH --job-name=dectiger_small
#SBATCH --mem=30G
#SBATCH --output=output_dectiger_small.log
...
echo "Run problem : dectiger with horizon: $1 and iter : $2"
python experiment_script.py problem=dectiger horizon=$1 iter=$2
echo " SOLVING DONE"
