...
#SBATCH --error=error_file_recycling_small.txt
#SBATCH --job-name=recycling_small
#SBATCH --mem=20G
#SBATCH --output=output_recycling_small.log
...
echo "Run problem : recycling with horizon: $1 and iter : $2"
python experiment_script.py problem=recycling horizon=$1 iter=$2
echo " SOLVING DONE"
