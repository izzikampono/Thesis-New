...
#SBATCH --error=error_file_relay4_densities.txt
#SBATCH --job-name=relay4
#SBATCH --mem=40G
#SBATCH --output=output_relay4_densities.log
...
echo "Run problem : relay4 with horizon: $1 and iter : $2, starting density : $3"
