...
#SBATCH --mem=30G
#SBATCH --output=output_GridSmall_densities.log
...
echo "Run problem : GridSmall with horizon: $1 and iter : $2, starting density : $3"
cd /scratch/s3918343/venvs/thesis/Thesis-New
python -m pip install joblib
python densities_experiment.py problem=GridSmall horizon=$1 iter=$2 density=$3
echo " SOLVING DONE"
