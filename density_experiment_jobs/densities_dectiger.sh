...
#SBATCH --error=error_file_dectiger_densities.txt
#SBATCH --job-name=dectiger
#SBATCH --mem=30G
#SBATCH --output=output_dectiger_densities.log
...
echo "Run problem : dectiger with horizon: $1 and iter : $2, starting density : $3"
cd /scratch/s3918343/venvs/thesis/Thesis-New
python -m pip install joblib
python densities_experiment.py problem=dectiger horizon=$1 iter=$2 density=$3
echo " SOLVING DONE"
